...
def test_code(test_case):
    ...
    side_a = 1.501
    side_b = sqrt(pow((sqrt(WC[0]**2 + WC[1]**2) - 0.35), 2) + pow((WC[2] - 0.75), 2))  #!!!!!!!!!!!!!! zamieniec potegi na mnozenie
    side_c = 1.25
    ...
    your_wc = [WC[0],WC[1],WC[2]]# Wrc # <--- Load your calculated WC values in this array
    your_ee = [FK[0,3],FK[1,3],FK[2,3]] #[vectBase[0],vectBase[1],vectBase[2]] # <--- Load your calculated end effector value from your forward kinematics
    ########################################################################################
